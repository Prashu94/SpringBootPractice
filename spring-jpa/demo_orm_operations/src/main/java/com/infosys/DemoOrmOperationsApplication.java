...
public class DemoOrmOperationsApplication implements CommandLineRunner{
	public static final Log LOGGER = LogFactory.getLog(DemoOrmOperationsApplication.class);
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(DemoOrmOperationsApplication.class, args);
	}
	...
	public void getCustomer(Integer customerID) throws InfyBankException{
		try {
	...
	public void updateCustomer(Integer customerId){
		try{
			Integer updatedCustomerId = customerService.updateCustomer(1006, "harryp@infy.com");
