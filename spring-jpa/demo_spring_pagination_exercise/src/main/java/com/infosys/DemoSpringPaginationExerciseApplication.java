...
import com.infosys.service.PlayerService;

@SpringBootApplication
public class DemoSpringPaginationExerciseApplication implements CommandLineRunner{

	private static final Log LOGGER = LogFactory.getLog(DemoSpringPaginationExerciseApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(DemoSpringPaginationExerciseApplication.class, args);
	}
