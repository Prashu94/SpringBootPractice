...
// Configuration tells SpringBoot that this is a configuration file
@Configuration
// Base Package to scan for components
@ComponentScan(basePackages = "com.prospring5")
// Helps to enable Transaction Management in Spring
...
public class AppConfig {
	...
	private Properties hibernateProperties() {
		...
		hibernateProperties.put("hibermate.jdbc.fetch_size", 50);
