...
public class ExceptionControllerAdvice {
	...
	// this helps receiving the message/value related to the general exceptions from the ValidationMessages.properties
	@Autowired
	private Environment environment;
	
	// Handler for exception other than NoSuchCustomerException and validation exceptions
	...
	public ResponseEntity<ErrorMessage> exceptionHandler(Exception e) {
		...
		errorMessage.setMessage(environment.getProperty(InfyTelConstants.GENERAL_EXCEPTION_MESSAGE.toString()));
	...
	// Handler that handles the exception raised because of invalid data that is being received as method argument(DTO)
	...
	// Handler that handles the exception raised because of invalid data that is received as URI parameter
	// (path variable, request parameters)
