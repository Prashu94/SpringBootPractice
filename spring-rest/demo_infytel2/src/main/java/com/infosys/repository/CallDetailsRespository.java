...
@Repository
public class CallDetailsRespository {
	...
	public void populateCalledOn() {
		...
		callDetails = new ArrayList<CallDetailsDTO>();
	...
	// To fetch the call details based on calledBy and calledOn attributes of the CallDetailsDTO
	public List<CallDetailsDTO> fetchCallDetails(long calledBy, LocalDate calledOn){
		
		List<CallDetailsDTO> callDetailsResultSet = new ArrayList<CallDetailsDTO>();
